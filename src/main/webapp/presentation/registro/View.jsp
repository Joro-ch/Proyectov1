        ...
        <div class = "cuerpo">
            <form class = "cuerpo-form">
                <div class = "cuerpo-form__DatosUsuario">
                    ...
                    <input class = "cuerpo-form__input" type="text" id="correo" autocomplete="off" placeholder="Ingrese su Correo" name="correo">
                </div>
                <div class = "cuerpo-form__DatosTarjeta">
                    ...
                    <input class = "cuerpo-form__input" type="text" id="fechaExp" autocomplete="off" placeholder="Ingrese la Fecha de Expiración" name="fechaExp">
