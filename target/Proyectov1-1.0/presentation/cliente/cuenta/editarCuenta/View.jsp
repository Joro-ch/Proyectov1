        ...
        <div class = "cuerpo">
            <form class = "cuerpo-form" action = "./presentation/cliente/cuenta/editarCuenta/enviar" method = "POST">
                ...
                <div class = "cuerpo-form__DatosUsuario">
                    ...
                    <input class = "cuerpo-form__input" type="email" id="correo" autocomplete="off" value = "<%= cliente.getCorreo() %>" name="correo">
                </div>
                <div class = "cuerpo-form__DatosTarjeta">
                    ...
                    <input class = "cuerpo-form__input" type="date" id="fechaExp" autocomplete="off" value = "<%= cliente.getTarjeta().getFechaExp()%>" name="fechaExp">
